...
<div id="page" class="site">
        <a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'wp-bootstrap-starter' ); ?></a>
                ...
                <div id="hf13-notice" style="display:none; position:fixed; top:0; left:0; right:0; background:linear-gradient(135deg,#1290a7 0%,#5f5bc7 100%); color:#fff; padding:10px 50px 10px 20px; text-align:center; z-index:10000; font-size:15px; line-height:1.4;">
                                ...
                                <nav class="navbar navbar-dark navbar-expand-xl" aria-label="Main navigation">
                                        ...
                                        <div class="navbar-brand">
                                                <a href="<?php echo esc_url( home_url( '/' )); ?>" aria-label="Nerva — home">
                                                        ...
                                                        <img class="nerva-logo-word" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" src="<?php echo get_template_directory_uri() . '/images/logo.png'; ?>">
                                                </a>
                                        </div>
